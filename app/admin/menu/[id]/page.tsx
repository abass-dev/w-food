                ...
                try {
                    const response = await fetch('/api/admin/orders', {
                        ...
                        body: JSON.stringify({
                            ...
                            customerPhone: session.user.phoneNumber || '', // Assuming you've added phoneNumber to the user profile
                            items: [{ id: menuItem.id, quantity, price: menuItem.price }],
                            total: menuItem.price * quantity,
                            restaurantId: menuItem.category.restaurantId, // Assuming you have this information
                        }),
                    })
